                        ...
                        <div class="create-workform">
                            <div class="d-flex flex-wrap align-items-center justify-content-between">
                                <div class="modal-product-search d-flex flex-wrap">
                                    ...
                                    <a href="./Add-personal-trainer.php"
                                            ...
                                            <thead class="table-color-heading">
                                                <tr class="text-light">
                                                    ...
                                                    <th scope="col" class="text-start">
                                                        <span class="text-muted">Assign Member</span>
                                                    </th>
                                                    <th scope="col" class="text-start">
                                                    ...
                                                    <td class="">
                                                        <div class="active-project-1 d-flex align-items-center mt-0 ">
                                                            ...
                                                            <div class="data-content">
                                                                <div><span class="fw-bold">Aman Sharma</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="text-start">98765 43210</td>
                                                    <td>aman.sharma@email.com</td>
                                                    <td>Male</td>
                                                    <td>30</td>
                                                    <td>
                                                        15
                                                ...
                                                <tr class="white-space-no-wrap">
                                                    <td class="">
                                                        <div class="active-project-1 d-flex align-items-center mt-0 ">
                                                            ...
                                                            <div class="data-content">
                                                                <div><span class="fw-bold">Priya Nair</span></div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="text-start">87654 32109</td>
                                                    <td>priya.nair@email.com</td>
                                                    <td>Female</td>
                                                    <td>28</td>
                                                    <td>12</td>
                                                ...
                                                <tr class="white-space-no-wrap">
                                                    <td class="">
                                                        <div class="active-project-1 d-flex align-items-center mt-0 ">
                                                            ...
                                                            <div class="data-content">
                                                                <div><span class="fw-bold">Rohan Mehta</span></div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="text-start">76543 21098</td>
                                                    <td>rohan.mehta@email.com</td>
                                                    <td>Male</td>
                                                    <td>35</td>
                                                    <td>
                                                        18
                                                ...
                                                <tr class="white-space-no-wrap">
                                                    <td class="">
                                                        <div class="active-project-1 d-flex align-items-center mt-0 ">
                                                            ...
                                                            <div class="data-content">
                                                                <div><span class="fw-bold">Aditya Kumar</span></div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="text-start">54321 09876</td>
                                                    <td>aditya.kumar@email.com</td>
                                                    <td>Male</td>
                                                    <td>40</td>
                                                    <td>
                                                        20
