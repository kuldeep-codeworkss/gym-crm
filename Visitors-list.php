                            ...
                            <div class="card card-block card-stretch">
                                <div class="card-body p-0">
                                    <div class="d-flex justify-content-between align-items-center p-3 pb-md-0">
                                        <h5 class="fw-bold">Visitors List</h5>
                                            ...
                                            <tbody>
                                                <tr class="white-space-no-wrap">
                                                    ...
                                                    <td class="text-center">
                                                        <span class="mt-2 badge px-2 py-1 rounded-pill bg-primary">New</span>
                                                    </td>
                                                    <td>
                                                        <div
                                                ...
                                                <tr class="white-space-no-wrap">
                                                    ...
                                                    <td>kanhu77@gmail.com</td>
                                                    <td>23</td>
                                                    <td>16/03/2001</td>
                                                    <td class="text-center">
                                                        <span class="mt-2 badge px-2 py-1 rounded-pill bg-primary">Lost</span>
                                                    </td>
                                                    <td>
                                                        <div
                                                            class="d-flex gap-2 justify-content-strat align-items-center">
                                                ...
                                                <tr class="white-space-no-wrap">
                                                    ...
                                                    <td class="text-center">9004991399</td>
                                                    <td>NikhilNadkar127@gmail.com</td>
                                                    <td>24</td>
                                                    <td>22/08/2001</td>
                                                    <td class="text-center">
                                                        <span class="mt-2 badge px-2 py-1 rounded-pill bg-primary">Converted to Member</span>
                                                    </td>
                                                    <td>
                                                        <div
                                                            class="d-flex gap-2 justify-content-strat align-items-center">
                                                ...
                                                <tr class="white-space-no-wrap">
                                                    ...
                                                    <td class="text-center">90044991322</td>
                                                    <td>Rohitwagadi@gmail.com</td>
                                                    <td>21</td>
                                                    <td>03/03/2002</td>
                                                    <td class="text-center">
                                                        <span class="mt-2 badge px-2 py-1 rounded-pill bg-primary">Lost</span>
