    ...
    <div class="iq-navbar-custom">
        <nav class="navbar navbar-expand-lg navbar-light p-0">
            ...
            <div class="d-flex align-items-center">
                    ...
                    <li class="nav-item nav-icon dropdown">
                        <a href="#" class="search-toggle dropdown-toggle" id="notification-dropdown"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                class="h-6 w-6 text-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                ...
                                                <div class="avatar">
                                                    <div class="avatar-img bg-success avatar-20">
                                                        <span><img class="avatar is-squared rounded-circle"
                                                                src="assets/images/user/2.jpg" alt="2.jpg"></span>
                                                    </div>
                                                </div>
                                                <div class="list-style-detail ms-2 me-2">
                                                    ...
                                                    <div class="avatar-img bg-warning avatar-20">
                                                        <span>
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                ...
                                                                width="30" height="30" stroke="white" id="Capa_1"
                ...
                <a href="#" class="position-relative nav-item  admin-user d-flex   dropdown-toggle"
                    id="dropdownMenuButton" data-bs-toggle="dropdown">
                    <h6 class="position-absolute font-size-18 user-name text-center">A</h6>
                </a>
