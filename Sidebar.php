            ...
            <ul id="iq-sidebar-toggle" class="side-menu">
                ...
                <li class=" sidebar-layout">
                    <a href="./Add-Member.php" class="svg-icon ">
                        ...
                        <span class="ms-2">Add Member</span>
                    </a>
                </li>
                <li class=" sidebar-layout">
                    <a href="./Member-List.php" class="svg-icon">
                        ...
                        <span class="ms-2">View Member</span>
                    </a>
                </li>
                <!-- Visitors -->
                <li class="px-3 pt-3 pb-2 ">
                ...
                <li class=" sidebar-layout">
                    <a href="./Add-visitors.php" class="svg-icon ">
                        ...
                        <span class="ms-2">Add Visitors</span>
                    </a>
                </li>
                <li class=" sidebar-layout">
                    <a href="./Visitors-list.php" class="svg-icon">
                        ...
                        <span class="ms-2">View Visitors</span>
                    </a>
                </li>
                <!-- Expenses -->
                <li class="px-3 pt-3 pb-2 ">
                ...
                <li class=" sidebar-layout">
                    <a href="./Add-events.php" class="svg-icon ">
                        ...
                        <span class="ms-2">Add Events</span>
                    </a>
                </li>
                <li class=" sidebar-layout">
                    <a href="./Events-list.php" class="svg-icon">
                        ...
                        <span class="ms-2">View Events</span>
                    </a>
                </li>
            </ul>
        </nav>
